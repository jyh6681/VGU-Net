...
from .swinpart import PatchEmbedding, SwinTransformerStage
...
class SwinTransformerV2(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> List[torch.Tensor]:
        ...
        for stage in self.stages:
            ...
            print("stage::::",output.shape)
            features.append(output)
        print("feat:",len(features),features[0].shape)
        return features
...
def swin_transformer_v2_g(input_resolution: Tuple[int, int],
    ...
    return SwinTransformerV2(input_resolution=input_resolution,
                             ...
                             depths=(2, 2, 42, 2),#(2, 2, 6,2),#,
                             number_of_heads=(16, 32, 64, 128),#(2,4,8,16),#,
                             **kwargs)