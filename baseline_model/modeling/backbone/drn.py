...
def drn_a_50(BatchNorm, pretrained=False):
...
def drn_c_26(BatchNorm, pretrained=False):
...
def drn_c_42(BatchNorm, pretrained=False):
...
def drn_c_58(BatchNorm, pretrained=False):
...
def drn_d_22(BatchNorm, pretrained=False):
...
def drn_d_24(BatchNorm, pretrained=False):
...
def drn_d_38(BatchNorm, pretrained=False):
...
def drn_d_40(BatchNorm, pretrained=False):
...
def drn_d_105(BatchNorm, pretrained=False):
